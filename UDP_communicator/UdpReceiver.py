...
# use it with  udpSender9.ino / udpSender10.ino
...
MAX_WAIT_CYCLES = 20                            # application Rx timeout; in 50 mSec blocks 
#-------------------------------------------------------------------------------------------
   
class ThermalUdp (threading.Thread):
                ...
                while (next_chunk_num < CHUNKS_PER_FRAME): # TODO: watchdog to force out of this loop
                    try:
                        ...
                        if (not self.store(next_chunk_num)):
                            ...
                            next_chunk_num = 0    # get a fresh frame
                            sleep(0.02)
